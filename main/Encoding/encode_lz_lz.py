...
##########################################################################################################
# run: python encode_lz_lz.py -c config_encode_yolo.json 2>&1 | tee logs_lz_lz.txt
##########################################################################################################
...
def _main_(args):
    ...
    with tf.Session() as sess:
        ...
        encode_lziv(sess, codes=codes, codebook_kb=codebook_kb, codes_kb=codes_kb, original_kb=original_kb,
                  verbose=verbose, first_encoder='lziv')
